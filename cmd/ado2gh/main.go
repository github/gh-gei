...
func newRootCmd() *cobra.Command {
	...
	rootCmd.AddCommand(newLockAdoRepoCmdLive())
	rootCmd.AddCommand(newDisableAdoRepoCmdLive())
	rootCmd.AddCommand(newConfigureAutolinkCmdLive())
	rootCmd.AddCommand(newShareServiceConnectionCmdLive())
	rootCmd.AddCommand(newTestPipelinesCmdLive())
	// Shared commands from internal/sharedcmd
