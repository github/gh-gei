...
namespace OctoshiftCLI.Tests.BbsToGithub.Commands
{
    public class MigrateRepoCommandTests
    {
        ...
        public void Should_Have_Options()
        {
            ...
            TestHelpers.VerifyCommandOption(_command.Options, "aws-access-key", false);
            TestHelpers.VerifyCommandOption(_command.Options, "aws-secret-key", false);
        ...
        public async Task Uses_Aws_If_Credentials_Are_Passed()
        {
            ...
            _mockAwsApiFactory.Setup(x => x.Create(AWS_ACCESS_KEY, AWS_SECRET_KEY)).Returns(_mockAwsApi.Object);
