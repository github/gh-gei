...
namespace OctoshiftCLI.Tests.AdoToGithub.Commands
{
    public class InventoryReportCommandTests
    {
        ...
        {
            _command = new InventoryReportCommand(TestHelpers.CreateMock<OctoLogger>().Object, _mockAdoApiFactory.Object, _mockAdoInspector.Object, _mockOrgsCsvGenerator.Object, _mockTeamProjectsCsvGenerator.Object, _mockReposCsvGenerator.Object)
            {
        ...
        public async Task Happy_Path()
        {
            ...
            _mockReposCsvGenerator.Setup(m => m.Generate(_mockAdoApi.Object, ADO_REPOS)).Returns(expectedReposCsv);
