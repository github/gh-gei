...
public sealed class GitlabSshArchiveDownloaderTests : IDisposable
{
    ...
    private readonly GitlabSshArchiveDownloader _bbsArchiveDownloader;

    public GitlabSshArchiveDownloaderTests()
    {
        _bbsArchiveDownloader = new GitlabSshArchiveDownloader(_mockOctoLogger.Object, _mockFileSystemProvider.Object, _mockSftpClient.Object)
        {
            GitlabSharedHomeDirectory = BBS_HOME_DIRECTORY
        };
