...
public class GitlabSmbArchiveDownloaderTests
{
    ...
    private readonly GitlabSmbArchiveDownloader _bbsArchiveDownloader;

    public GitlabSmbArchiveDownloaderTests()
    {
        _bbsArchiveDownloader = new GitlabSmbArchiveDownloader(
