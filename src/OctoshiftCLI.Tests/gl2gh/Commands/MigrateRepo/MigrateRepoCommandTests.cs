...
public class MigrateRepoCommandTests
{
    ...
    private readonly Mock<GitlabArchiveDownloaderFactory> _mockGitlabArchiveDownloaderFactory = TestHelpers.CreateMock<GitlabArchiveDownloaderFactory>();
    ...
    public MigrateRepoCommandTests()
    {
        ...
        _mockServiceProvider.Setup(m => m.GetService(typeof(GitlabArchiveDownloaderFactory))).Returns(_mockGitlabArchiveDownloaderFactory.Object);
    ...
    [Fact]
    public void BuildHandler_Creates_Gitlab_Ssh_Archive_Downloader_Based_On_Server_Url_When_Ssh_User_Is_Provided()
    {
        // Arrange
        ...
        _mockGitlabArchiveDownloaderFactory.Verify(m => m.CreateSshDownloader(BBS_HOST, SSH_USER, SSH_PRIVATE_KEY, SSH_PORT, BBS_SHARED_HOME));
    }

    [Fact]
    public void BuildHandler_Creates_Gitlab_Ssh_Archive_Downloader_When_Ssh_User_And_Archive_Download_Host_Is_Provided()
    {
        // Arrange
        var args = new MigrateRepoCommandArgs
        {
        ...
        // Assert
        handler.Should().NotBeNull();
        _mockGitlabArchiveDownloaderFactory.Verify(m => m.CreateSshDownloader(ARCHIVE_DOWNLOAD_HOST, SSH_USER, SSH_PRIVATE_KEY, SSH_PORT, BBS_SHARED_HOME));
    }

    [Fact]
    public void BuildHandler_Creates_Gitlab_Smb_Archive_Downloader_Based_On_Server_Url_When_Smb_User_Is_Provided()
    {
        // Arrange
        var args = new MigrateRepoCommandArgs
        {
        ...
        // Assert
        handler.Should().NotBeNull();
        _mockGitlabArchiveDownloaderFactory.Verify(m => m.CreateSmbDownloader(BBS_HOST, SMB_USER, SMB_PASSWORD, SMB_DOMAIN, BBS_SHARED_HOME));
    }

    [Fact]
    public void BuildHandler_Creates_Gitlab_Smb_Archive_Downloader_When_Smb_User_And_Archive_Download_Host_Is_Provided()
    {
        // Arrange
        var args = new MigrateRepoCommandArgs
        {
        ...
        // Assert
        handler.Should().NotBeNull();
        _mockGitlabArchiveDownloaderFactory.Verify(m => m.CreateSmbDownloader(ARCHIVE_DOWNLOAD_HOST, SMB_USER, SMB_PASSWORD, SMB_DOMAIN, BBS_SHARED_HOME));
    }
    ...
    public void BuildHandler_Creates_The_Handler()
    {
        ...
        _mockGitlabApiFactory.Verify(m => m.Create(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<bool>()), Times.Never);
        _mockGitlabArchiveDownloaderFactory.Verify(m => m.CreateSshDownloader(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<string>()), Times.Never);
        _mockGitlabArchiveDownloaderFactory.Verify(m => m.CreateSmbDownloader(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()), Times.Never);
    ...
    public void BuildHandler_Creates_Gitlab_Api_When_Gitlab_Server_Url_Is_Provided()
    {
        ...
        _mockGitlabApiFactory.Verify(m => m.Create(BBS_SERVER_URL, BBS_USERNAME, BBS_PASSWORD, false));
    }
    ...
    public void It_Gets_A_No_Ssl_Verify_HttpClient_When_No_Ssl_Verify_Is_True()
    {
        ...
        _mockGitlabApiFactory.Verify(m => m.Create(BBS_SERVER_URL, BBS_USERNAME, BBS_PASSWORD, true));
    }
}
