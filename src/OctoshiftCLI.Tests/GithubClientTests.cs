...
namespace OctoshiftCLI.Tests
{
    public sealed class GithubClientTests : IDisposable
    {
        ...
        public async Task GetAsync_Returns_String_Response()
        {
            ...
            var githubClient = new GithubClient(_mockOctoLogger.Object, httpClient, null, _retryPolicy, null, null);
        ...
        public async Task GetAsync_Encodes_The_Url()
        {
            ...
            var handlerMock = MockHttpHandlerForGet();
            using var httpClient = new HttpClient(handlerMock.Object);
            var githubClient = new GithubClient(_mockOctoLogger.Object, httpClient, null, _retryPolicy, null, PERSONAL_ACCESS_TOKEN);
        ...
        public async Task GetAsync_Applies_Retry_Delay()
        {
            ...
            dateTimeMock.Setup(m => m.CurrentUnixTimeSeconds()).Returns(now);
            ...
            using var httpClient = new HttpClient(handlerMock.Object);
            var githubClient = new GithubClient(_mockOctoLogger.Object, httpClient, null, retryPolicy, dateTimeMock.Object, PERSONAL_ACCESS_TOKEN);
        ...
        public async Task PostAsync_Throws_HttpRequestException_On_Non_Success_Response()
        {
            ...
            await FluentActions
                ...
                {
                    using var httpClient = new HttpClient(handlerMock.Object);
                    var githubClient = new GithubClient(loggerMock.Object, httpClient, null, _retryPolicy, null, PERSONAL_ACCESS_TOKEN);
...
query($id: ID!, $first: Int, $after: String) {
    node(id: $id) { 
        ...
        public async Task PostGraphQLWithPaginationAsync_Throws_If_Result_Collection_Selector_Is_Null()
        {
            ...
            var githubClient = new GithubClient(null, httpClient, null, _retryPolicy, null, PERSONAL_ACCESS_TOKEN);
...
query($id: ID!, $first: Int, $after: String) {
    node(id: $id) { 
        ...
        public void It_Sets_User_Agent_Header_With_Comments()
        {
            ...
            // Act
            _ = new GithubClient(null, httpClient, mockVersionProvider.Object, _retryPolicy, null, PERSONAL_ACCESS_TOKEN);
        ...
        public void It_Only_Sets_The_Product_Name_In_User_Agent_Header_When_Version_Provider_Is_Null()
        {
            ...
            // Act
            _ = new GithubClient(null, httpClient, null, _retryPolicy, null, PERSONAL_ACCESS_TOKEN);
