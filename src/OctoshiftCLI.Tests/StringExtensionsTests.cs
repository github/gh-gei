...
namespace OctoshiftCLI.Tests
{
    public sealed class StringExtensionsTests
    {
        ...
        [InlineData("https://api.evil.example?x=.ghe.com", false)]
        [InlineData("https://api.evil.example#.ghe.com", false)]
        [InlineData("https://user:pass@api.tenant.ghe.com", false)]
        [InlineData("ftp://api.tenant.ghe.com", false)]
        [InlineData("", false)]
        [InlineData(null, false)]
        [InlineData("   ", false)]
