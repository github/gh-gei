...
public class AwsApiFactory
{
    ...
    public virtual AwsApi Create(string awsAccessKey = null, string awsSecretKey = null, string awsSessionToken = null)
    {
        ...
        return new AwsApi(accessKey, secretKey, sessionToken);
    }
}
