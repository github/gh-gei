...
public class GithubClient
{
    ...
    public virtual async Task<(string Content, KeyValuePair<string, IEnumerable<string>>[] ResponseHeaders)> PostTupleAsync(string url, object body, Dictionary<string, string> customHeaders = null) =>
    ...
    public virtual async Task<(string Content, KeyValuePair<string, IEnumerable<string>>[] ResponseHeaders)> PatchTupleAsync(string url, object body, Dictionary<string, string> customHeaders = null) =>
