...
public class GithubClient
{
    ...
    public GithubClient(OctoLogger log, HttpClient httpClient, IVersionProvider versionProvider, RetryPolicy retryPolicy, DateTimeProvider dateTimeProvider, string personalAccessToken)
    {
        ...
        if (_httpClient != null)
        {
            ...
            _httpClient.DefaultRequestHeaders.Add("GraphQL-Features", "import_api,mannequin_claiming_emu,mannequin_claiming_bot,org_import_api,octoshift_ll_gitlab_self_serve");
