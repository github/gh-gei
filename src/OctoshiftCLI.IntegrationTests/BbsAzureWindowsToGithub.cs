...
public sealed class BbsAzureWindowsToGithub : IDisposable
{
    ...
    public BbsAzureWindowsToGithub(ITestOutputHelper output)
    {
    ...
    [Fact]
    public async Task MigrateRepo_BbsWindows_AzureStorage()
    {
        var bbsServer = "http://e2e-bbs-7-21-9-win-2019.westus2.cloudapp.azure.com:7990";
        ...
        var archiveDownloadOptions = " --smb-user octoshift";
